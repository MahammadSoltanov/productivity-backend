...
public sealed class Epic : TaskAbstract<EpicId>
{
    ...
    private Epic(EpicId id, string title, WorkspaceId workspaceId, UserId creatorId) : base(id, title, workspaceId, creatorId)
    {
